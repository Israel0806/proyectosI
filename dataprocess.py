...
class ParsecData:
    ...
    def __init__(self, modelFun=False, filename=None):
        """
    ...
    def speedups(self, serialfrequencyfixed = False):
        ...
        if len(ldims) == 2:
            ...
            if self.modelFun:
                ...
                xspeedup_mod = (timesonecore / times)[:,:]
        ...
        xspeedup_mod.attrs = times.attrs
        return times, xspeedup_mod, xspeedup
    ...
    def loaddata(self, foldername):
        ...
        if os.path.isdir(foldername):
            ...
            for root, dirs, files in os.walk(foldername):
                self.runfiles = [name for name in files]
            if self.runfiles:
