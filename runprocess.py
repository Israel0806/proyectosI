...
from _common import argsparseintlist, argsparseinputlist, procs_list
...
csv_handler = CSVHandler('executionVips.csv')
            ...
            for c in args.c:
                ...
                for r in range(args.repetitions):
                    ...
                    try:
                        ...
                        print('execution-' + str(c) + '-' + str(f) + '-' + str(r+1))
                        ctx.record(tag='execution-' + str(c) + '-' + str(f) + '-' + str(r+1))
                        waitForCMD(res)
                        ctx.record(tag='endExecution-' + str(c) + '-' + str(f) + '-' + str(r+1))
                        print('endexecution-' + str(c) + '-' + str(f) + '-' + str(r+1))
...
with EnergyContext(handler=csv_handler, domains=[RaplPackageDomain(0)], start_tag='main_start') as ctx:
    main()
